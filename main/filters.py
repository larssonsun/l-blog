...
SWITCH_i18n = dict(
    ...
    default_meta_desctiption=lambda x: "本站基于协程, 涉及python asyncio标准库、 aiohttp异步http框架等后端技术，前端使用Uikit3进行构建, 不断完善中",
    ...
    resetpwd_title=lambda x: "密码修改",
    resetpwd_orgpwd=lambda x: "原密码",
    resetpwd_newpwd=lambda x: "新密码",
    resetpwd_renewpwd=lambda x: "再次输入新密码",
    resetpwd_submitchg=lambda x: "确定",
    resetpwd_cancelchg=lambda x: "放弃",
